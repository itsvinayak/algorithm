...
How do you find the missing number in a given integer array of 1 to 101?  
...
How to check if a given number is even/odd without using Arithmetic operator?  
...
How to find sub array with maximum sum?  
